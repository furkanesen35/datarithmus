      ...
      <nav className="flex justify-between items-center bg-black text-white h-[50px] px-4">
        ...
        <div className="hidden lg:flex justify-around w-[500px]">
          <div className="relative">
            ...
            <div
              className={`absolute top-full left-0 bg-black w-[200px] transition-opacity duration-300 ${isCoursesDropdownOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
            >
              {coursesLinks}
            </div>
          </div>
        ...
        <div
          className={`lg:hidden absolute top-[50px] left-0 w-full bg-black transition-opacity duration-500 ${isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        >
          <div>
            <a
              href="#courses"
