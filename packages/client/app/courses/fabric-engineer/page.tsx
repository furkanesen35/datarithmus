...
export default function FabricEngineer() {
	return (
		<div className="min-h-screen bg-[#301934] w-full flex flex-col items-center py-12 px-4">
			...
			<p className="text-lg text-[#e4ed94]/80 mb-8 max-w-3xl text-center">Microsoft Fabric Engineer Certification. Learn to design, implement, and manage Fabric solutions for enterprise data.</p>
